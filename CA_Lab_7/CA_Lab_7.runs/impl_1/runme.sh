...
HD_PWD='C:/Users/User/CA_Lab_7/CA_Lab_7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lab6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_lab6.tcl -notrace
