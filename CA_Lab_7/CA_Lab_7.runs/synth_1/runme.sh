...
HD_PWD='C:/Users/User/CA_Lab_7/CA_Lab_7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_lab6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_lab6.tcl
